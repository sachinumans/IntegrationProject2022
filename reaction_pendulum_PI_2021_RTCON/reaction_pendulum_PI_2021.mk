...
MODEL                = reaction_pendulum_PI_2021
MODULES              = rt_matrx.c rt_printf.c rt_logging.c reaction_pendulum_PI_2021_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rtiostream_utils.c rtdacusb2_rpend_dd.c
MAKEFILE             = reaction_pendulum_PI_2021.mk
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = reaction_pendulum_PI_2021_ref.rsp
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\reaction_pendulum_PI_2021_RTCON
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\extern\include
